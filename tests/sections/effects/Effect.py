...
from tests.sections.trigger_data.effect import Effect as EffectStruct
...
class Effect(EffectStruct):
    ...
    def _make_effect(struct: EffectStruct) -> Effect:
        from tests.sections.effects.cd import ChangeDiplomacy
        from tests.sections.effects.rt import ResearchTechnology
