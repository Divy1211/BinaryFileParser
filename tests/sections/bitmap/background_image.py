...
from tests.sections.bitmap.bitmap_info_header import BitmapInfoHeader
...
class BackgroundImage(BaseStruct):
    ...
    height: int =                    Retriever(int32,                                        default = 0,                        on_read = [set_bmp_header_repeat, set_img_repeat], on_write = [set_bmp_header_repeat])
    orientation: int =               Retriever(int16,                                        default = 1)
    info_header: BitmapInfoHeader =  Retriever(BitmapInfoHeader,                             default_factory = BitmapInfoHeader)
