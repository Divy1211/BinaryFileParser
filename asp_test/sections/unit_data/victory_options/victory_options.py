...
from asp_test.sections.unit_data.victory_options.victory_condition import VictoryCondition
...
class VictoryOptions(BaseStruct):
    ...
    def __new__(cls, ver: Version = Version(2, 0), ctx: Context = None, init_defaults = True, **retriever_inits):
