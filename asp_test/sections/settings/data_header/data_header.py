...
class DataHeader(BaseStruct):
    ...
    num_max_players: int                         = Retriever(i32,                min_ver = Version(1, 53), default = 0)
    gaia_player_idx: int                         = Retriever(i32,                min_ver = Version(1, 53), default = 0)
    tribe_names: list[str]                       = Retriever(NtStr[256],         min_ver = Version(1, 14), default = "",                        repeat = 16)
    player_name_str_ids: list[int]               = Retriever(i32,                min_ver = Version(1, 17), default = -2,                        repeat = 16)
