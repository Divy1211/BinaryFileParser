...
class Options(BaseStruct):
    ...
    _disabled_tech_ids: list[list[int]]     = Retriever(StackedArray32[16][u32], min_ver = Version(1, 28),                           default_factory = lambda _: [[] for _ in range(16)])
    _disabled_unit_ids: list[list[int]]     = Retriever(StackedArray32[16][u32], min_ver = Version(1, 28),                           default_factory = lambda _: [[] for _ in range(16)])
    _disabled_building_ids: list[list[int]] = Retriever(StackedArray32[16][u32], min_ver = Version(1, 28),                           default_factory = lambda _: [[] for _ in range(16)])
    ...
    separator: bytes                        = Retriever(i32,                     min_ver = Version(1,  2),                           default = -99)
    ...
    str_sign3: int                          = Retriever(u16,                     min_ver = Version(1, 40),                           default = 2656)
