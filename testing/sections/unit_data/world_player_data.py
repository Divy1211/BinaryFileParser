...
class WorldPlayerData(BaseStruct):
    ...
    ore_x: float =            Retriever(float32, min_ver = Version((1, 13)), default = 100)
    trade_goods: float =      Retriever(float32, min_ver = Version((1, 13)), default = 0.0)
    population_limit: float = Retriever(float32, min_ver = Version((1, 14)), default = 200.0)
    # @formatter:on
