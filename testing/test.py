...
def main():
    ...
    scx = ScenarioSections.from_file(r"C:\Users\Divy\Games\Age of Empires 2 DE\76561198276345085\resources\_common\Kirby scxs\v1.47\!defense_written.aoe2scenario")
