...
class Bool(ParserType):
    ...
    @classmethod
    def from_generator(cls, igen: IncrementalGenerator, byteorder: Literal["big", "little"] = "little") -> bool:
        return cls.from_bytes(igen.get_bytes(cls._byte_len), byteorder)

    @classmethod
    def from_bytes(cls, bytes_: bytes, byteorder: Literal["big", "little"] = "little") -> bool:
